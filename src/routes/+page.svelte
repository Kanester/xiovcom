...
<section>
	...
	<p>This is where I — Kiö — dump my thoughts, tips, and learning resources as well my projects; whether experimental or released.</p>
...
<section>
		<h2>About Me</h2>
		<p>Hey, I'm Kiö — a senior high school student currently taking Accountancy and Business Management strand. But let’s be real, I spend most of my free time coding just for fun.</p>
		<p>I'm completely self-taught. I learn by watching YouTube tutorials, messing around with code, and reading documentation when I need answers.</p>
		<p>I like building experimental stuff — random ideas that pop into my head. Though, I dream of creating something meaningful that could actually help people someday.</p>
		<p>Outside of coding, I’m into JPop and indie-pop music. I also write stories and poems when I’m in the mood for something more chill and creative.</p>
		<p>As for CSS and design? Yeah... not my strong suit. I know, even this site's design doesn't satisfy me.</p>
</section>
